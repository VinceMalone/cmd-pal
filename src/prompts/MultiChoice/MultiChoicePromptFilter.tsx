...
export interface MultiChoicePromptFilterProps
  extends Pick<TextboxTokenProps, 'as'> {}

export const MultiChoicePromptFilter: React.FC<MultiChoicePromptFilterProps> = ({
  as,
}) => {
  ...
  return (
    <TextboxToken
      ...
      onSubmit={chosen => submit(chosen as ChoiceListItem[])}
